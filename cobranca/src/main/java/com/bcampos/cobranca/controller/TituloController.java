package com.bcampos.cobranca.controller;
...
import com.bcampos.cobranca.service.CadastroTituloService;
...
public class TituloController {
	...
	//public ModelAndView pesquisar(@RequestParam(defaultValue = "%") String filtro)
	//List<Titulo> todosTitulos = cadastroTituloService.findAll();
	@RequestMapping
	public ModelAndView pesquisar(@ModelAttribute("filtro") TituloFilter filtro){
		List<Titulo> todosTitulos = cadastroTituloService.pesquisarTitulo(filtro);
